...
// profile state on disk, the key store, controller HTTP/gRPC access, the OIDC
...
type Profile struct {
	ControllerGRPC string `json:"controller_grpc"` // host:7401
	ControllerHTTP string `json:"controller_http"` // https://host:7402
