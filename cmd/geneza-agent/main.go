...
func enrollCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "enroll",
		Short: "Enroll this node with the controller (token, or openstack-metadata PoC seam)",
	...
	cmd.Flags().StringVar(&controller, "controller", "", "controller gRPC address host:port (overrides config)")
