...
import (
	...
	"geneza.io/internal/sessionhost"
...
func init() {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return sessionhost.Run(version.Version, socket, spool, drainStatus)
		},
	}
	...
	cmd.Flags().StringVar(&drainStatus, "drain-status", "", "file to report drain status (draining flag + live active count) for the bootstrap's swap gate")
